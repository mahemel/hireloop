...
const PricingPage = () => {
    ...
    const activePlans =
        billingTarget === "seeker" ? seekerPlans : recruiterPlans;
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <p className="text-zinc-400 mt-3 text-sm sm:text-base leading-relaxed">
                        Whether you are an ambitious job seeker hunting for your
                        next milestone or an expanding operation tracking down
                        pristine talent, we have got you covered.
                    </p>
                </div>
                ...
                <div className="max-w-3xl mx-auto border-t border-zinc-800 pt-16">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-xs text-zinc-500 mt-1">
                            Have concerns regarding billing pipelines? Find
                            instant clarify indicators below.
                        </p>
                    </div>
